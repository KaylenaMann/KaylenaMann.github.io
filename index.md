...
The main analysis and modeling pipeline consists of four scripts, where I utilized and compared **regular logistic regression**, **ridge logistic regression**, **K-Nearest Neighbors (KNN)**, and a **Random Forest** model.
...
Implemented a **three-parameter logistic (3PL) Item Response Theory model** to evaluate test quality and item characteristics across 500 examinees.  
Analyzed item difficulty, discrimination, and guessing parameters while incorporating priors for improved estimate stability.  
Evaluated model fit indices, classical item statistics, and person-fit diagnostics to identify problematic items and response patterns.
